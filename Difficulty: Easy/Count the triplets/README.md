<h2><a href="https://www.geeksforgeeks.org/problems/count-the-triplets4615/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Count the triplets</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><div><span style="font-size: 18px;">Given an array <strong>Arr</strong> consisting of <strong>N</strong> distinct integers. The task is to count all the triplets such that sum of two elements equals the third element.</span></div>
<div>&nbsp;</div>
